...
import { ContentType, BookContent, WordContent } from '../../lib/types';
import { ArrowRight, Star, Sparkles } from 'lucide-react';

export default function PostsPage() {
    const items = ALL_CONTENT.filter(item => item.type === ContentType.POST);
    const title = 'Essays';
    const description = 'Reflections on design, philosophy, and the quiet structure of things.';
    const accentColor = 'text-blue-700 dark:text-blue-300';
