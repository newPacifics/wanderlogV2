...
export default function LibraryPage() {
    const items = ALL_CONTENT.filter(item => item.type === ContentType.BOOK);
    const title = 'Library';
    const description = 'Notes, summaries, and marginalia from my reading log.';
    const accentColor = 'text-amber-700 dark:text-amber-300';
