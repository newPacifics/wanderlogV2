...
- [ ] Install contentlayer2 and next-contentlayer2 packages
- [ ] Create contentlayer.config.ts with schema definitions
- [ ] Wrap next.config.ts with withContentlayer
- [ ] Create content/ folder structure and migrate 8 MDX files
- [ ] Update lib/types.ts to use Contentlayer-generated types
- [ ] Replace lib/data.ts with Contentlayer imports
- [ ] Update all page components to use MDX rendering
- [ ] Add .contentlayer to .gitignore and update package.json scripts